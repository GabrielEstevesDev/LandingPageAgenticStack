    ...
    <section id="legal" className="section-fixed border-t border-white/5">
      ...
      >
        <div className="flex items-center gap-4 mb-6 lg:mb-10">
          ...
          <h2 className="text-3xl lg:text-4xl font-black tracking-tighter uppercase italic">Mentions Légales</h2>
        </div>

        <div className="grid md:grid-cols-2 gap-5 lg:gap-10 text-[11px] leading-relaxed text-white/40 uppercase tracking-wider font-bold">
          <div className="space-y-6 lg:space-y-8 bg-white/[0.02] border border-white/5 p-5 lg:p-8 rounded-3xl">
            <div>
        ...
        <div className="mt-6 lg:mt-12 text-center text-[9px] font-black text-white/10 uppercase tracking-[1em]">
